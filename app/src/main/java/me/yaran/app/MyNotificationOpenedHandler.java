...
/**
 * Created by Atiar on 12/14/2018.
 */
...
public class MyNotificationOpenedHandler implements OneSignal.NotificationOpenedHandler {
    ...
    public void notificationOpened(OSNotificationOpenResult result) {
        ...
        if (result.notification.payload.launchURL != null){
            ...
            Log.e(tag,result.notification.payload.launchURL.toString());

            BP.setPreferenceUrlNeedToOpe(MyApplication.getContext(),result.notification.payload.launchURL.toString());
